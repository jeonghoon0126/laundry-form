...
- `왕산로 200, 1004호`는 2026-07-01~07-31 월·목 임시 추가 후 2026-08-01부터 2026-04-06 기준 2주 간격 월요일 주기로 복귀
...
## 숙소 (운영 10개)
장충동(메종드브릭) / 제기동(스테이브리즈) / 건대(화양프라하임) / 회기(오를리) / 청량리(롯데캐슬) / 강남(신규 숙소, 건물 앞 정차 권장, 5층 엘리베이터 옆 수납창고) / 송파(스테이브리즈) / 신림(스테이모먼트) / 연남(에코리빙) / 이태원(서울특별시 용산구 회나무로 50, 5층 엘리베이터 진입 후 반층 위 렉 설치 예정)
