...
- `왕산로 200, 1004호`는 2026-07-01부터 2026-07-31까지만 월요일과 목요일 동선에 모두 포함
- `왕산로 200, 1004호`는 2026-08-01부터 2026-04-06 기준 2주 간격 월요일 주기로 복귀
- `봉은사로37길 8`은 2026-05-28(목)부터 추가, 부평 출발/복귀 기준으로 강남을 먼저 방문
- `장한로26나길 21`은 2026-06-01부터 운영 중지로 동선과 06/01 이후 정산에서 제외
- `서울특별시 용산구 회나무로 50 (이태원동)`은 2026-08-01부터 이태원 동선에 추가
...
## 숙소 (운영 9개)
장충동(메종드브릭) / 제기동(스테이브리즈) / 건대(화양프라하임) / 회기(오를리) / 청량리(롯데캐슬) / 강남(강남 언주로 숙소, 서울 강남구 봉은사로37길 8, 5층 엘리베이터 옆 수납창고) / 송파(스테이브리즈) / 신림(스테이모먼트) / 연남(에코리빙) / 이태원(서울특별시 용산구 회나무로 50, 5층 엘리베이터 진입 후 반층 위 렉 설치 예정)
