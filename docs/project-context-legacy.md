...
- `왕산로 200, 1004호`는 2026-04-09(목) 1회 추가, 2026-04-06(월)을 기준으로 2주 간격 월요일마다 포함
- `봉은사로37길 8`은 2026-05-28(목)부터 추가, 부평 출발/복귀 기준으로 강남을 먼저 방문
...
## 숙소 (10개)
장충동(메종드브릭) / 제기동(스테이브리즈) / 건대(화양프라하임) / 회기(오를리) / 장한평(프라하임장안2) / 청량리(롯데캐슬, 장한평 동일 슬롯) / 강남(신규 숙소, 상세주소 확인 필요) / 송파(스테이브리즈) / 신림(스테이모먼트) / 연남(에코리빙)
...
## 단가
이불 3,000 / 매트 2,000 / 베개커버 250 / 타올 500 / 바디타올 800 / 배게 솜 5,000 / 솜 이불 15,000
